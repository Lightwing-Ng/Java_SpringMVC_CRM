...
<%@ taglib prefix="lightwing" uri="http://lightwing.cn/common/" %>
<%
        ...
        <ul class="nav navbar-top-links navbar-right">
            <li class="dropdown">
                <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                    <span class="fa fa-envelope fa-fw" style="font-style: italic;"></span>
                    <span class="fa fa-caret-down" style="font-style: italic;"></span>
                </a>
                <ul class="dropdown-menu dropdown-messages">
                    ...
                    <li class="divider"></li>
                    <li>
                        <a class="text-center" href="#"> <strong>查看全部消息</strong>
                            <span class="fa fa-angle-right" style="font-style: italic;"></span>
                        </a>
                    </li>
            ...
            <li class="dropdown">
                <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                    <span class="fa fa-tasks fa-fw" style="font-style: italic;"></span>
                    <span class="fa fa-caret-down" style="font-style: italic;"></span>
                </a>
                <ul class="dropdown-menu dropdown-tasks">
                    <li><a href="#">
                        <div>
                            <p>
                                <strong>任务 1</strong> <span
                                    class="pull-right text-muted">完成40%</span>
                            </p>
                    ...
                    <li class="divider"></li>
                    <li>
                        <a class="text-center" href="#"> <strong>查看所有任务</strong>
                            <span class="fa fa-angle-right" style="font-style: italic;"></span>
                        </a>
                    </li>
            ...
            <li class="dropdown"><a class="dropdown-toggle"
                ...
                <span class="fa fa-bell fa-fw" style="font-style: italic;"></span>
                <span class="fa fa-caret-down" style="font-style: italic;"></span>
            </a>
                <ul class="dropdown-menu dropdown-alerts">
                    <li><a href="#">
                        <div>
                            <span class="fa fa-comment fa-fw" style="font-style: italic;">
                            </span> 新回复
                    ...
                    <li>
                        <a href="#">
                            <div>
                            <span class="fa fa-envelope fa-fw" style="font-style: italic;">
                            </span> 新消息 <span
                    ...
                    <li>
                        <a href="#">
                            <div>
                                <span class="fa fa-tasks fa-fw" style="font-style: italic;">
                                </span>新任务
                                <span class="pull-right text-muted small">4分钟之前</span>
                            </div>
                        </a>
            ...
            <li class="dropdown"><a class="dropdown-toggle"
                ...
                <ul class="dropdown-menu dropdown-user">
                    ...
                    <li>
                        <a href="login.html">
                            <span class="fa fa-sign-out fa-fw" style="font-style: italic;">
                            </span>
                            退出登录</a>
                    </li>
                </ul> <!-- /.dropdown-user --></li>
                ...
                <ul class="nav" id="side-menu">
                            ...
                            <span class="input-group-btn">
								<button class="btn btn-default" type="button">
									<span class="fa fa-search"
                                          style="padding: 3px 0 3px 0; font-style: italic;">
                                    </span>
								</button>
							</span>
                        </div> <!-- /input-group -->
                    ...
                    <li>
                        <a href="customer.action" class="active">
                            <span class="fa fa-edit fa-fw" style="font-style: italic;"></span>
                            客户管理
                        </a>
                    </li>
                ...
                <form class="form-inline"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="customerName"
                               value="${ vo.custName }" name="custName">
                    </div>
                    <div class="form-group">
                        ...
                        <select class="form-control" id="customerFrom" placeholder="客户来源"
                            ...
                            <c:forEach items="${ fromType }" var="item">
                                <option value="${ item.dict_id}"<c:if
                                        test="${ item.dict_id == vo.custSource}">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="custIndustry" name="custIndustry">
                            ...
                            <c:forEach items="${industryType}" var="item">
                                <option value="${item.dict_id}"<c:if
                                        test="${item.dict_id == vo.custIndustry}"> selected</c:if>>${item.dict_item_name }</option>
                            </c:forEach>
                        </select>
                    </div>
                    <div class="form-group">
                        ...
                        <select class="form-control" id="custLevel" name="custLevel">
                            ...
                            <c:forEach items="${ levelType}" var="item">
                                <option value="${ item.dict_id}"
                                        <c:if test="${ item.dict_id == vo.custLevel }"> selected</c:if>>
                ...
                <form class="form-horizontal" id="edit_customer_form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" id="edit_customerFrom" placeholder="客户来源"
                                ...
                                <c:forEach items="${ fromType }" var="item">
                                    <option value="${ item.dict_id }"<c:if
                                            test="${ item.dict_id == custSource }"> selected
                                    </c:if>>${item.dict_item_name }</option>
                                </c:forEach>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" id="edit_custIndustry"
                                    name="cust_industry">
                                <option value="">--请选择--</option>
                                <jsp:useBean id="industryType" scope="request"
                                             type="java.util.List"/>
                                <c:forEach items="${ industryType }" var="item">
                                    <option value="${item.dict_id}"
                                            <c:if test="${item.dict_id == custIndustry }">
                                                selected</c:if>>${item.dict_item_name }
                                    </option>
                                </c:forEach>
                            </select>
                        </div>
                    ...
                    <div class="form-group">
                        <label for="edit_custLevel"
                               style="float:left;padding:7px 15px 0 27px;">客户级别
                        </label>
                        <div class="col-sm-10">
